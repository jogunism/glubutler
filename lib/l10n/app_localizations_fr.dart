...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get chartSizeLarge => 'Grand';

  @override
  String get chartSizeSmall => 'Petit';
  ...
  @override
  String get yearOfDiagnosis => 'Année de diagnostic';
  ...
  String get notificationPermissionDescription =>
      'Activez les autorisations de notification dans les paramètres iOS pour recevoir des notifications.';

  @override
  String get allowNotifications => 'Autoriser';
  ...
  @override
  String get noReportTitle => 'Aucun rapport';

  @override
  String get noReportYet => 'Générez votre rapport de glycémie !';
  ...
  @override
  String get trendInfoTitle => 'Guide de tendance glycémique';

  @override
  String get trendInfoPeriodTitle => 'Comparaison de la glycémie par période';

  @override
  String get trendInfoPeriodDesc =>
      'Appuyez sur le graphique pour comparer la glycémie d\'aujourd\'hui avec les périodes passées. Seule la date d\'aujourd\'hui peut être comparée.';

  @override
  String get trendInfoZoomTitle => 'Zoom avant et arrière du graphique';

  @override
  String get trendInfoZoomDesc =>
      'Pincez ou écartez avec deux doigts pour agrandir ou réduire le graphique pour une vue plus détaillée.';
  ...
  @override
  String get syncPeriod6Months => '6 mois';

  @override
  String get syncPeriod9Months => '9 mois';

  @override
  String get syncPeriod12Months => '12 mois';
  ...
  String get initCheckingGoogle =>
      'Vérification de la synchronisation Google...';

  @override
  String get initCheckingHealthConnect =>
      'Vérification de la synchronisation Health Connect...';
  ...
  @override
  String get initNotifications => 'Configuration des notifications...';
  ...
  @override
  String get deleteGlucose => 'Supprimer l\'enregistrement de glucose';

  @override
  String get deleteInsulin => 'Supprimer l\'enregistrement d\'insuline';

  @override
  String get deleteGlucoseConfirmation =>
      'Cet enregistrement de glucose sera supprimé.';

  @override
  String get deleteInsulinConfirmation =>
      'Cet enregistrement d\'insuline sera supprimé.';
  ...
  @override
  String get mealAddedToFeed => 'Informations sur le repas ajoutées au fil';
  ...
  String dataSyncPeriodInfo(String period) {
    return '* Affichage des données de $period récentes.\n* Peut être modifié dans Paramètres > Apple Health > Paramètres de période de synchronisation.';
  }

  @override
  String get syncPeriodSetting => 'Paramètres de période de synchronisation';

  @override
  String get generateReport => 'Générer un rapport';

  @override
  String get reportRequiresICloud => 'Générer un rapport';
  ...
  @override
  String get pastReports => 'Rapports précédents';
  ...
  String reportWillBeDeleted(String period) {
    return 'Voulez-vous vraiment supprimer le rapport $period ?\nLes rapports supprimés ne peuvent pas être régénérés.';
  }
  ...
  @override
  String get iCloudSyncEnabled => 'Synchronisation iCloud activée';
  ...
  @override
  String get googleSyncFailed => 'Échec de la connexion Google';

  @override
  String get googleNotSignedIn => 'Échec de la connexion au compte Google';

  @override
  String get googleSync => 'Synchronisation Google';

  @override
  String get googleSyncEnabled => 'Synchronisation Google activée';

  @override
  String get googleSyncDisabled => 'Synchronisation Google désactivée';

  @override
  String get healthConnectDescription =>
      'Connectez-vous à Health Connect pour accéder à des données utiles à la gestion de votre glycémie.';

  @override
  String get connectHealthConnect => 'Connecter Health Connect';

  @override
  String get disconnectedHealthConnect => 'Déconnecté de Health Connect';

  @override
  String get failedToConnectHealthConnect =>
      'Échec de connexion. Vérifiez vos autorisations dans Health Connect.';

  @override
  String get privacyNoteAndroid =>
      'Vos données de santé sont stockées uniquement sur votre appareil et ne sont jamais partagées. Gérez l\'accès dans Health Connect > Données et confidentialité > Glu Butler.';

  @override
  String get feedEmptyHintAndroid =>
      'Connectez Health Connect pour plus d\'informations';

  @override
  String get reportRequiresGoogleMessage =>
      'La synchronisation du compte Google est requise pour générer des rapports.\nParamètres > Synchronisation Google';
  ...
  String get onboardingFastingGlucoseTitle =>
      'Quel est votre objectif de glycémie à jeun?';

  @override
  String get onboardingFastingGlucoseSubtitle =>
      'Définissez votre objectif et suivez votre quotidien';

  @override
  String onboardingFastingGlucoseValidation(String min, String max) {
    return 'Veuillez entrer une valeur entre $min et $max';
  }
  ...
  @override
  String get onboardingHealthTitle => 'Connectez-vous avec Apple Health';
  ...
  String get onboardingHealthTitleAndroid =>
      'Connectez-vous avec Health Connect';
  ...
  String get hcNotInstalled =>
      'Health Connect n\'est pas installé. Installez-le pour synchroniser vos données de santé.';

  @override
  String get hcNeedsUpdate =>
      'Health Connect doit être mis à jour pour se connecter.';

  @override
  String get hcInstallFromPlayStore => 'Installer depuis le Play Store';

  @override
  String get hcUpdateFromPlayStore => 'Mettre à jour depuis le Play Store';

  @override
  String get onboardingReportTitle => 'Recevez des rapports glycémiques';

  @override
  String get onboardingReportSubtitle =>
      'Obtenez des rapports périodiques basés sur vos données enregistrées';

  @override
  String get onboardingReportICloudRequired => 'Synchronisation iCloud requise';

  @override
  String get onboardingReportGoogleRequired =>
      'Synchronisation du compte Google requise';

  @override
  String get onboardingReportEnable => 'Synchroniser iCloud';

  @override
  String get onboardingNotificationTitle => 'Recevez des notifications';

  @override
  String get onboardingNotificationSubtitle =>
      'Nous vous aiderons à maintenir des enregistrements quotidiens réguliers';
  ...
  @override
  String get onboardingSubscriptionFeature2 => 'Analyses et rapports avancés';
  ...
  @override
  String get onboardingSubscriptionMonthlyPrice => '6,99 €/mois';

  @override
  String get onboardingSubscriptionYearly => 'Plus Annuel';

  @override
  String get onboardingSubscriptionYearlyPrice => '49,99 €/an';
  ...
  @override
  String get onboardingSubscriptionRedeem => 'Utiliser un code';

  @override
  String get onboardingSubscriptionRestore => 'Restaurer l\'achat';

  @override
  String get onboardingSubscriptionPurchase => 'Acheter';

  @override
  String get onboardingCompletionTitle => 'Tout est prêt !';

  @override
  String get onboardingCompletionSubtitle =>
      'Gérez votre glycémie plus intelligemment avec Glu Butler';

  @override
  String get onboardingCompletionFeature1 => 'Insights santé par IA';

  @override
  String get onboardingCompletionFeature2 => 'Synchronisation illimitée';

  @override
  String get onboardingCompletionFeature3 => 'Rapports avancés';
  ...
  String get mealGlucoseReminders =>
      'Rappels de glycémie avant petit-déjeuner, déjeuner, dîner';

  @override
  String get longTermGlucoseAbsence =>
      'Alerte d\'absence prolongée d\'enregistrement de glycémie';
  ...
  String get notifReportReminderTitle =>
      'Générez votre rapport de glycémie et consultez les résultats';

  @override
  String get notifGlucoseReminderTitle =>
      'Vérifiez et enregistrez votre glycémie';

  @override
  String get notifDiaryReminderTitle => 'Enregistrez votre repas';

  @override
  String get notifDiaryReminderBody => 'Suivez vos habitudes alimentaires';

  @override
  String get notifGlucoseRecordReminderTitle =>
      'N\'oubliez pas de mesurer votre glycémie';
  ...
  String get onboardingTermsPrefix =>
      'En utilisant Glu Butler,\nvous acceptez nos';

  @override
  String get onboardingTermsAnd => 'et';
  ...
  String get yearlyDescription =>
      'Toutes les fonctionnalités premium pour 1 an';

  @override
  String get monthlyDescription =>
      'Toutes les fonctionnalités premium pour 1 mois';
  ...
  @override
  String get diaryAddMealToFeed => 'Ajouter comme repas au fil';

  @override
  String get mealWindow30min => '30 min';

  @override
  String get mealWindow1hour => '1 heure';

  @override
  String get mealWindow1hour30min => '1h 30min';

  @override
  String get mealWindow2hours => '2 heures';

  @override
  String get tapToCompare => 'Appuyer pour comparer';

  @override
  String get compThisWeek => 'Cette semaine';

  @override
  String get compLastWeek => 'La semaine dernière';

  @override
  String get comp3WeeksAgo => 'Il y a 3 semaines';

  @override
  String get comp1MonthAgo => 'Il y a 1 mois';

  @override
  String get comp2MonthsAgo => 'Il y a 2 mois';

  @override
  String get comp3MonthsAgo => 'Il y a 3 mois';

  @override
  String get comp6MonthsAgo => 'Il y a 6 mois';
}
